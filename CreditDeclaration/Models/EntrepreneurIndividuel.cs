...
namespace CreditDeclaration.Models
{
    ...
    public class EntrepreneurIndividuel
    {
        ...
        [Column("fond_propre", TypeName = "decimal(18,0)")]
        public decimal? FondPropre { get; set; }

        [Column("recette", TypeName = "decimal(18,0)")]
        ...
        public Activite? CodeActiviteData { get; set; }

        [Column("adresse_activite", TypeName = "nvarchar(100)")]
        public string? AdresseActivite { get; set; }


        
        [Column("adresse_activite_wilaya", TypeName = "nvarchar(3)")]
        public string? AdresseActiviteWilaya { get; set; }
        [ForeignKey("AdresseActiviteWilaya")]
        public Wilaya? AdresseActiviteWilayaData { get; set; }


        [Column("adresse_activite_commune", TypeName = "nvarchar(3)")]
